...
function StarryWindowImageComponent({ size = 1, planetColor = 'teal', backgroundColor = '#202020', pantsColor = '#202020', shirtColor = 'darkslategrey', hairColor = 'black', skinColor = 'pink', leafColor = 'teal', windowColor = 'white' }) {
	...
	// Preventing the case where size == 20 (cant divide by 0)
	return (
		<Svg data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width={Math.floor(927.76 / (20 - sizing))} height={Math.floor(742.508 / (20 - sizing))} viewBox='0 0 927.76 742.508'>
			<Defs>
				<LinearGradient id='prefix__a' x1={728.763} y1={387.373} x2={815.573} y2={387.373} gradientUnits='userSpaceOnUse'>
					<Stop offset={0} stopColor='#fff' />
					<Stop offset={1} stopColor='#fff' stopOpacity={0.3} />
				</LinearGradient>
				<LinearGradient id='prefix__b' x1={725.763} y1={217.373} x2={812.573} y2={217.373} xlinkHref='#prefix__a' />
			</Defs>
			<Path d='M927.76 251.193v193.18H425.38v-193.18a249.99 249.99 0 0150.23-150.72A251.155 251.155 0 01662.07.413q7.185-.42 14.5-.41c2.77 0 5.54.04 8.28.14a250.354 250.354 0 01169.33 73.43c1.36 1.36 2.69 2.73 4.03 4.11a253.05 253.05 0 0119.32 22.79 250.055 250.055 0 0150.23 150.72z' fill={backgroundColor} />
			<Circle cx={802.645} cy={177.292} r={66.193} fill={planetColor} />
			...
			<Path d='M96.424 544.564c-13.25 18.73-16.75 125.33-17.53 159.5-.02.77-.04 1.5-.05 2.19h-33.54c-.41-.73-.79-1.45-1.15-2.19-19.88-39.24-8.85-86.29-8.27-88.67-1.51 7.48 5.32 29.16 13.04 50.16 4.71-64.57 44.98-117.73 47.5-120.99z' fill={leafColor} />
			<Path d='M303.245 448.59l-3.796 16.45s1.266 37.96-8.857 34.164-7.593-36.696-7.593-36.696l8.858-16.45z' fill={skinColor} />
			<Circle cx={246.937} cy={242.968} r={25.307} fill={skinColor} />
			<Path d='M227.324 249.928l-2.531 36.695 31.634 3.796s0-30.368 2.53-34.164-31.633-6.327-31.633-6.327z' fill={skinColor} />
			<Path d='M297.478 297.715L256.487 280.4s-19.587-15.086-31.06-3.91l-5.149 7.375s-45.537 17.755-45.525 31.674l17.776 69.58s-10.088 39.234 5.098 41.752l82.255 7.52s11.376-13.93 1.238-31.635l3.76-41.76z' fill={shirtColor} />
			<Path d='M269.64 299.005l27.838-1.29s8.86 2.523 15.207 26.56 7.648 63.261 7.648 63.261l-15.123 70.873-18.982-2.514 7.532-68.336-12.693-45.542zM189.93 306.667l-13.721 4.287s-11.568 17.246-11.56 26.104-4.995 75.926-4.995 75.926l32.947 54.382 10.1-26.582-20.276-34.147 16.413-41.771z' fill={shirtColor} />
			<Path d='M283.632 431.507l-90.975-8.004s-8.988 57.353-7.723 80.13 2.53 58.206 2.53 58.206l-10.122 154.374 39.226-5.061 5.062-127.802 16.45-69.595 18.98 88.576 12.653 113.882 34.165-3.796-11.388-137.924s10.123-124.006-8.858-142.986z' fill={pantsColor} />
			<Path d='M296.286 706.09l11.388 3.796s24.042-6.327 17.715 10.123-24.042 13.92-24.042 13.92-21.511 16.449-30.368 3.795l5.06-26.572zM203.914 706.09l11.389 3.796s24.042-6.327 17.715 10.123-24.042 13.92-24.042 13.92-21.511 16.449-30.369 3.795l5.062-26.572zM227.324 265.112s-26.573-18.98-12.654-41.757c9.656-15.8 29.665-14.55 41.015-12.302a19.175 19.175 0 0114.028 11.037c1.898 4.429 1.898 8.858-5.694 8.858-15.184 0-7.592 11.388-7.592 11.388s-10.123 2.53-7.592 11.388-21.511 11.388-21.511 11.388z' fill={hairColor} />
		</Svg>
	);
}

export default StarryWindowImageComponent;
