...
function PlanetIconComponent({ size = 1, planetColor = 'teal', carColor = 'darkorange', circlesColor = 'gold', starsColor = 'steelblue' }) {
  ...
  return (
    <Svg
      ...
      width={Math.floor(829 / (20 - sizing))}
      height={Math.floor(744.16 / (20 - sizing))}
      ...
      <Path
        d='M539 557.92zM529.65 571.43a55.65 55.65 0 009.35-13.46 59.11 59.11 0 005.17-13.29l-5.17-2.69-14 27zM497.931 559.061l17.342-33.384.932.484a4.32 4.32 0 011.842 5.825l-13.368 25.735a4.32 4.32 0 01-5.825 1.842l-.932-.484.009-.018z'
        fill='#4a5c81'
      />
      <Path
        d='M440.76 537.01l.646-1.242 54.044 28.073-3.301 6.354-48.923-25.413a5.76 5.76 0 01-2.465-7.772zM464.622 491.068l.646-1.242a5.76 5.76 0 017.766-2.456l48.932 25.418-3.3 6.354-54.044-28.074z'
        fill={carColor}
      />
      ...
      <Path
        d='M458.325 558.017l2.305-4.437 6.354 3.3-4.96 9.549-1.225-.636a5.76 5.76 0 01-2.474-7.776zM500.69 491.754l-4.956 9.54-6.354-3.3 2.305-4.438a5.76 5.76 0 017.766-2.456l1.243.645-.005.01z'
        fill={carColor}
      />
      ...
      <Path
        d='M503.86 568.03a12.27 12.27 0 0017.47-3.9M526.16 525.13a12.27 12.27 0 016.84 16.52M448.89 525.34s-1.41-12.84 11.56-22.25M454.89 528.46s-1.41-12.84 11.56-22.25'
        opacity={0.05}
      />
      ...
      <Path
        d='M486.327 527.925l-.21-1.029a2.16 2.16 0 011.685-2.548l11.515-2.35a2.21 2.21 0 012.608 1.723l.634 3.107-13.72 2.8a2.16 2.16 0 01-2.512-1.703z'
        fill='#cdefff'
      />
