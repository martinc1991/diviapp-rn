	...
	return (
		<View style={styles.container}>
			<ScrollView contentContainerStyle={{ width: windowWidth, alignItems: 'center', padding: 15 }}>
				...
				<View style={styles.bodyContainer}>
					<Text style={styles.textBody}>
						Mi nombre es Martín, tengo {years} años, soy <Text style={styles.textHighlight}>Desarrollador Web Full Stack</Text>, amante de la buena música 🎵 y entusiasta de todo lo relacionado al espacio exterior 🚀.
					</Text>
				</View>
				<View style={styles.bodyContainer}>
