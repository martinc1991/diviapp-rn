  ...
  return (
    <DrawerContentScrollView {...props} style={styles.mainDrawerContainer}>
      ...
      <View style={styles.sectionTitlesContainer}>
        <DrawerItem
          icon={() => {
            return <Ionicons name='ios-home' color={theme.primary} size={20} style={{ marginHorizontal: 0, justifyContent: 'center', alignItems: 'center' }}></Ionicons>;
          }}
          label='Inicio'
                    ...
                    icon={() => {
                      return (
                        <Ionicons
                          ...
                          color={theme.primary}
                          size={22}
                          style={{ marginHorizontal: 0, justifyContent: 'center', alignItems: 'center' }}></Ionicons>
                      );
                    }}
                    label={enlace.label}
                    labelStyle={styles.text}
      ...
      <View style={styles.configContainer}>
        ...
        <View style={styles.hrElement}></View>
        <DrawerItem
          label={DarkModeDrawerItem}
          icon={() => {
            return <Ionicons name={theme.isDark ? 'ios-moon' : 'ios-sunny'} size={20} color={theme.primary} style={{ marginHorizontal: 0 }}></Ionicons>;
          }}
          onPress={() => {}}
        />
      </View>
